...
describe('fingerprint generation', () => {
	...
	it('fingerprints', async () => {
		...
		const expectFingerprints = {
			[CARD_ID_ONE]: new Map([
				[ 'crystal', 0.1937550385738479 ],
				[ 'card', 0.11326951095344248 ],
				[ 'titl', 0.11121228098520877 ],
				[ 'surf', 0.11121228098520877 ],
				[ 'bodi', 0.10282698293493824 ],
				[ 'seed', 0.08849222123665341 ],
				[ 'uncertainti', 0.08849222123665341 ],
				[ 'gradient', 0.07595691481881621 ],
				[ 'concept', 0.07096951717500606 ],
				[ 'kei', 0.06695423690357578 ],
				[ 'lot', 0.05452981916757584 ],
				[ 'down', 0.0538732341920695 ],
				[ 'understand', 0.04343866794059888 ],
				[ 'thi', 0.04187569314573037 ],
				[ 'them', 0.022341455314532823 ],
				[ 'complex', 0.015463525490362433 ]
			]),
			[CARD_ID_TWO]: new Map([
				[ 'cynefin', 0.05702526735301833 ],
				[ 'model', 0.05483327184454064 ],
				[ 'terminolog', 0.03283928630537875 ],
				[ 'call', 0.0324091540763332 ],
				[ 'unknow', 0.02639502797128374 ],
				[ 'chaotic', 0.02639502797128374 ],
				[ 'complic', 0.025246658132216392 ],
				[ 'requir', 0.02110952345007148 ],
				[ 'cynefin\'', 0.019792016107537155 ],
				[ 'blammo', 0.019792016107537155 ],
				[ 'cynenfin', 0.019792016107537155 ],
				[ 'hard', 0.018925253228717416 ],
				[ 'divid', 0.018299717301980534 ],
				[ 'four', 0.018299717301980534 ],
				[ 'method', 0.018299717301980534 ],
				[ 'inscrut', 0.018299717301980534 ],
				[ 'i’v', 0.018299717301980534 ],
				[ 'cynfefin’', 0.018299717301980534 ],
				[ 'knowabl', 0.017240914449367824 ],
				[ 'unclear', 0.017240914449367824 ],
				[ 'intric', 0.016419643152689376 ],
				[ 'distinguish', 0.016419643152689376 ],
				[ 'special', 0.015748615643811203 ],
				[ 'dupe', 0.01468981279119849 ],
				[ 'diagnos', 0.014256316838254582 ]
			]),
			[CARD_ID_THREE]: new Map([
				[ 'let', 0.043497990438022154 ],
				[ 'go', 0.03210913139421103 ],
				[ 'detail', 0.024788455022975338 ],
				[ 'truth', 0.024544481299120742 ],
				[ 'attent', 0.019625696644448607 ],
				[ 'complex', 0.019102002076330067 ],
				[ 'becom', 0.018154376396404676 ],
				[ 'unnatur', 0.0181459381649891 ],
				[ 'cosmic', 0.0181459381649891 ],
				[ 'calm', 0.0181459381649891 ],
				[ 'uncomfort', 0.0181459381649891 ],
				[ 'onli', 0.017199463535648083 ],
				[ 'pai', 0.017096032815339522 ],
				[ 'type', 0.01685746959283662 ],
				[ 'latter', 0.016281662958128964 ],
				[ 'embrac', 0.015616274335880016 ],
				[ 'scari', 0.015616274335880016 ],
				[ 'import', 0.015331294567270191 ],
				[ 'correctli', 0.015053696271757214 ],
				[ 'solut', 0.014800219171107127 ],
				[ 'diagnos', 0.014136515856420508 ],
				[ 'illus', 0.013751999129019876 ],
				[ 'gradient', 0.013404161438614625 ],
				[ 'bias', 0.013404161438614625 ],
				[ 'littl', 0.013404161438614625 ]
			]),
			[CARD_ID_FOUR]: new Map([
				[ 'truth', 0.0859056845469226 ],
				[ 'ground', 0.03175539178873093 ],
				[ 'land', 0.028492910176725686 ],
				[ 'true', 0.02382761902028114 ],
				[ 'you\'v', 0.023457282517575593 ],
				[ 'ever', 0.021917056774634226 ],
				[ 'it\'', 0.01959485005912864 ],
				[ 'modern', 0.01717248456389253 ],
				[ 'not', 0.016925067590006133 ],
				[ 'process', 0.01606499782357485 ],
				[ 'motion', 0.015877695894365464 ],
				[ 'subject', 0.015877695894365464 ],
				[ 'incorpor', 0.014959028713422081 ],
				[ 'learn', 0.014319559774585166 ],
				[ 'inconveni', 0.013664240043895014 ],
				[ 'asymptot', 0.013664240043895014 ],
				[ 'later', 0.013664240043895014 ],
				[ 'disconfirm', 0.013171984237787563 ],
				[ 'post', 0.013171984237787563 ],
				[ 'spectrum', 0.013171984237787563 ],
				[ 'outsid', 0.013171984237787563 ],
				[ 'directli', 0.013171984237787563 ],
				[ 'hill', 0.01274557286295163 ],
				[ 'longer', 0.01274557286295163 ],
				[ 'affect', 0.012369451374367945 ]
			]),
			[CARD_ID_FIVE]: new Map([
				[ 'site', 0.0959718507392757 ],
				[ 'stuff', 0.0959718507392757 ],
				[ 'quot', 0.08611190631188208 ],
				[ 'hill', 0.07703990708272986 ],
				[ 'climb', 0.0727327953934829 ],
				[ 'https://www.wikipedia.org/blammo', 0.0518990644597641 ],
				[ 'impor', 0.0518990644597641 ],
				[ 'komoroske.com/sudoku', 0.0518990644597641 ],
				[ 'washingtonpost.com', 0.0518990644597641 ],
				[ 'same', 0.0491115101916049 ],
				[ 'boundari', 0.04305595315594104 ],
				[ 'realli', 0.041296369910438266 ],
				[ 'here', 0.041296369910438266 ],
				[ 'edg', 0.039808663474202415 ],
				[ 'e.g', 0.033834323201033974 ],
				[ 'interest', 0.033119108015002834 ],
				[ 'think', 0.03283825800279662 ],
				[ 'about', 0.032595462638285416 ],
				[ 'great', 0.030171873231123032 ],
				[ 'card', 0.02642955255580325 ],
				[ 'lot', 0.025447248944868727 ],
				[ 'know', 0.025447248944868727 ],
				[ 'anoth', 0.022067449330381735 ],
				[ 'detail', 0.021850564057289374 ],
				[ 'import', 0.020271378372279478 ]
			])
		};
		for (let cardID of CARD_IDS_TO_TEST) {
	...
	it('overlaps work with already-provided cards', async () => {
		...
		const expectedOverlaps = {
			[CARD_ID_ONE]: new Map([
				[ 'five', 2.21967613162169 ],
				[ 'three', 2.123926603824123 ],
				[ 'two', 0 ],
				[ 'four', 0 ]
			]),
			[CARD_ID_TWO]: new Map([
				[ 'three', 1.0283928326946752 ],
				[ 'one', 0 ],
				[ 'four', 0 ],
				[ 'five', 0 ]
			]),
			[CARD_ID_THREE]: new Map([
				[ 'one', 2.123926603824123 ],
				[ 'five', 2.0822416920198146 ],
				[ 'four', 1.1104501658460433 ],
				[ 'two', 1.0283928326946752 ]
			]),
			[CARD_ID_FOUR]: new Map([
				[ 'three', 1.1104501658460433 ],
				[ 'five', 1.0897854799456814 ],
				[ 'one', 0 ],
				[ 'two', 0 ]
			]),
			[CARD_ID_FIVE]: new Map([
				[ 'one', 2.21967613162169 ],
				[ 'three', 2.0822416920198146 ],
				[ 'four', 1.0897854799456814 ],
				[ 'two', 0 ]
			]),
		};

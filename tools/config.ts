...
const generateConfig = () => {
	...
	const FIRESTORE_DATABASE_ID_DEV = config.dev?.firestore_database_id || '(default)';
	const FIRESTORE_DATABASE_ID_PROD = projectConfig.firestore_database_id || '(default)';
	...
	CONFIG_JS_CONTENT += 'export const FIRESTORE_DATABASE_ID_DEV = \'' + FIRESTORE_DATABASE_ID_DEV + '\';\n';
	CONFIG_JS_CONTENT += 'export const FIRESTORE_DATABASE_ID_PROD = \'' + FIRESTORE_DATABASE_ID_PROD + '\';\n';

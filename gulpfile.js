...
gulp.task(REGENERATE_FILES_FROM_CONFIG_TASK, function(done) {
	...
	const prodFirebaseConfig = projectConfig.firebase.prod;
	const devFirebaseConfig = projectConfig.firebase.dev;

	let CONFIG_JS_CONTENT = '// Generated by `gulp ' + REGENERATE_FILES_FROM_CONFIG_TASK + '`\n';
	CONFIG_JS_CONTENT += '/* eslint quotes:["error", "double"] */\n';
	CONFIG_JS_CONTENT += 'export const FIREBASE_DEV_CONFIG=' + JSON.stringify(devFirebaseConfig) + ';\n';
	CONFIG_JS_CONTENT += 'export const FIREBASE_PROD_CONFIG=' + JSON.stringify(prodFirebaseConfig) + ';\n';

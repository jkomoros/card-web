...
gulp.task(REGENERATE_FILES_FROM_CONFIG_TASK, function(done) {
	...
	CONFIG_JS_CONTENT += 'import { TabConfig, UserPermissions } from \'./types.js\';\n\n';
	CONFIG_JS_CONTENT += 'export const FIREBASE_DEV_CONFIG : FirebaseOptions = ' + JSON.stringify(CONFIG_FIREBASE_DEV) + ';\n';
	CONFIG_JS_CONTENT += 'export const FIREBASE_PROD_CONFIG : FirebaseOptions = ' + JSON.stringify(CONFIG_FIREBASE_PROD) + ';\n';
	CONFIG_JS_CONTENT += 'export const APP_TITLE : string = "' + APP_TITLE + '";\n';
	CONFIG_JS_CONTENT += 'export const USER_TYPE_ALL_PERMISSIONS : UserPermissions = ' + JSON.stringify(USER_TYPE_ALL_PERMISSIONS) + ';\n';
	CONFIG_JS_CONTENT += 'export const USER_TYPE_ANONYMOUS_PERMISSIONS : UserPermissions = ' + JSON.stringify(USER_TYPE_ANONYMOUS_PERMISSIONS) + ';\n';
	CONFIG_JS_CONTENT += 'export const USER_TYPE_SIGNED_IN_PERMISSIONS : UserPermissions = ' + JSON.stringify(USER_TYPE_SIGNED_IN_PERMISSIONS) + ';\n';
	CONFIG_JS_CONTENT += 'export const USER_TYPE_SIGNED_IN_DOMAIN_PERMISSIONS : UserPermissions = ' + JSON.stringify(USER_TYPE_SIGNED_IN_DOMAIN_PERMISSIONS) + ';\n';
	CONFIG_JS_CONTENT += 'export const USER_DOMAIN : string = "' + USER_DOMAIN + '";\n';
	CONFIG_JS_CONTENT += 'export const FIREBASE_REGION : string = "' + FIREBASE_REGION + '";\n';
	CONFIG_JS_CONTENT += 'export const TWITTER_HANDLE : string = "' + TWITTER_HANDLE + '";\n';
	CONFIG_JS_CONTENT += 'export const TAB_CONFIGURATION : TabConfig = ' + JSON.stringify(TAB_CONFIGURATION) + ';\n';
	CONFIG_JS_CONTENT += 'export const DISABLE_PERSISTENCE : boolean = ' + (DISABLE_PERSISTENCE ? 'true' : 'false') + ';\n';
	CONFIG_JS_CONTENT += 'export const DISABLE_ANONYMOUS_LOGIN : boolean = ' + (DISABLE_ANONYMOUS_LOGIN ? 'true' : 'false') + ';\n';
	CONFIG_JS_CONTENT += 'export const DISABLE_CALLABLE_CLOUD_FUNCTIONS : boolean = ' + (DISABLE_CALLABLE_CLOUD_FUNCTIONS ? 'true' : 'false') + ';\n';

...
const makeExtrasForFilterFunc = memoize((filterSetMemberships : Filters, cards : ProcessedCards, keyCardID : CardID, editingCard : ProcessedCard, userID : Uid, randomSalt : string, cardSimilarity: CardSimilarityMap) : FilterExtras => {
	return {
...
export class Collection {
	...
	get _filterExtras() : FilterExtras {
		if (!this._cachedFilterExtras) {
			this._cachedFilterExtras = makeExtrasForFilterFunc(this._filtersSnapshot || this._filters, this._cardsForFiltering, this._keyCardID, this._editingCard, this._userID, this._randomSalt, this._cardSimilarity);
		}
	...
	cardsThatWillBeRemoved() {
		...
		const [pendingFilterFunc,,] = combinedFilterForFilterDefinition(filterDefinition, makeExtrasForFilterFunc(this._filters, this._cardsForExpansion, this._keyCardID, this._editingCard, this._userID, this._randomSalt, this._cardSimilarity));

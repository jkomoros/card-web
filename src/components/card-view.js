        ...
        <div id='center'>
          <div id='canvas'>
            ...
            <div class='actions'>
              ...
              <div class='modify'>
			  	<button class='round ${this._cardInReadingList ? 'selected' : ''} ${this._userMayModifyReadingList ? '' : 'need-signin'}' @click='${this._handleReadingListClicked}'>${this._cardInReadingList ? playlistAddCheckIcon : playlistAddIcon }</button>

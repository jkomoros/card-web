...
export class CardRenderer extends LitElement {
  render() {
    return html`
      ...
      <content-card ?hidden=${this._cardType != 'content'} .fromContentEditable=${this.fromContentEditable} .editing=${this.editing} .id=${this._cardId} title="${this._title}" body="${this._body}" .fullBleed=${this._fullBleed} .starCount=${this.card.star_count}></content-card>
    `;
  }

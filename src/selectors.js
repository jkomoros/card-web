...
export const selectVisibleSubstantiveNonLinkReferencesForActiveCard = createSelector(
	selectActiveCard,
	selectCards,
	(card, cards) => references(card).substantiveNonLinkArray().filter(id => cards[id])
);
